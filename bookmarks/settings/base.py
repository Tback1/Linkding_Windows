...
if not SECRET_KEY:
    raise ImproperlyConfigured("LD_SECRET_KEY not set in environment")
...
# Add this section: Source directories for static files
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, "bookmarks", "styles"), # 用于 theme-light.css, theme-dark.css
    os.path.join(BASE_DIR, "bookmarks", "static"), # 用于 Linkding 自带的其他静态文件
    os.path.join(BASE_DIR, "assets"), # 如果 Linkding 源代码的 bundle.js 在 assets 目录下
]
